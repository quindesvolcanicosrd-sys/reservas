...
function _renderCardHome(r, hoy) {
  ...
  if (_prx.mapsUrl || _prx.descripcion || _prx.horaFin || _prx.duracion) {
    ...
    if (_prx.descripcion || _prx.horaFin || _prx.duracion) {
      h += '<button onclick="event.stopPropagation();var _e=document.getElementById(\'' + _infoId + '\');var _i=document.getElementById(\'' + _infoId + 'i\');var _o=_e.style.display!==\'none\';_e.style.display=_o?\'none\':\'block\';_i.style.transform=_o?\'\':\' rotate(180deg)\';" style="display:flex;align-items:center;width:100%;background:transparent;color:var(--brand);border:none;padding:4px 0;font-size:0.78rem;font-weight:600;cursor:pointer;font-family:inherit;gap:4px;">Ver más información<span class="material-symbols-outlined" id="' + _infoId + 'i" style="font-size:1rem;margin-left:auto;transition:transform 0.25s;">expand_more</span></button>';
