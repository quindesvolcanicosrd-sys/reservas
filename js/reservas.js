      ...
      fechas.forEach(function(f) {
        ...
        var _fExtra = (f.mapsUrl || f.descripcion || f.horaFin || f.duracion)
          ? '<div style="margin-top:6px;">' +
            ...
            (f.mapsUrl ? '<a href="' + f.mapsUrl + '" target="_blank" rel="noopener" onclick="event.stopPropagation()" style="display:inline-flex;align-items:center;gap:4px;background:var(--brand-light);color:var(--brand);border:1px solid var(--brand-warm-border);border-radius:20px;padding:4px 10px;font-size:0.72rem;font-weight:700;text-decoration:none;"><span class="material-symbols-outlined" style="font-size:0.82rem;">location_on</span>Cómo llegar</a>' : '') +
