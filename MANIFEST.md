...
│   ├── equipo.css               Sección Equipo: lista/acordeones por categoría + INACTIVOS/LESIONADXS (con círculo de tendencia de puntos por persona), nav con 2 triggers (avatar+"Mis estadísticas" / lupa) + paneles deslizables "Mis estadísticas" y búsqueda+filtros fusionados, perfil de detalle, termómetro
